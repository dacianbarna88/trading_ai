...
from research.momentum.momentum_continuation_research_v11 import (
    ENTRY_MODE,
    HISTORY_PERIOD,
    MIN_HISTORY_BARS,
    compute_rsi,
...
def load_universe() -> list[str]:
    ...
    if path.exists():
        ...
        if tickers:
            return tickers
    from research.momentum.momentum_universe_expansion_v13 import dedupe_universe, EXPANDED_US_UNIVERSE
