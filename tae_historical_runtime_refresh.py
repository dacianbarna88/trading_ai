...
HISTORICAL_SOURCES: tuple[HistoricalSourceSpec, ...] = (
    HistoricalSourceSpec(
        ...
        refresh_script="historical_intelligence_engine.py",
...
RECOMPUTE_DEPENDENTS: tuple[tuple[str, str, str], ...] = (
    ...
    ("strategic_allocation_runtime", "tae_strategic_allocation_runtime.py", "tae_strategic_allocation_runtime.json"),
)
