...
FADE_INTELLIGENCE_JSON = generated_report("tae_intraday_fade_intelligence.json")
...
OUTPUT_JSON = generated_report("tae_profit_protection_shadow.json")
OUTPUT_MD = generated_report("tae_profit_protection_shadow.md")
