#!/usr/bin/env python3
"""
Enrich live_signals.csv with historical intelligence context (read-only artifacts).
"""
...
from research_core.historical_intelligence.live_signals_enricher import enrich_live_signals_file

OUTPUT_JSON = "tae_live_signals_historical_enrich.json"
...
def main() -> int:
    ...
    print("===== TAE LIVE SIGNALS HISTORICAL ENRICH =====")
    ...
    print(f"Top strategy: {result.get('top_strategy')}")
