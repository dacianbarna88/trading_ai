#!/usr/bin/env python3
"""
Enrich live_signals.csv with research context from existing artifacts.
"""
...
from research_core.research_runtime.live_signals_enricher import enrich_live_signals_file

OUTPUT_JSON = "tae_live_signals_research_enrich.json"
...
def main() -> int:
    ...
    print("===== TAE LIVE SIGNALS RESEARCH ENRICH =====")
