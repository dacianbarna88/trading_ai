...
class HistoricalRuntimeRefreshTest(unittest.TestCase):
    def test_audit_detects_missing(self) -> None:
    ...
    def test_refresh_marks_stale_on_failure(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            ), mock.patch("tae_historical_runtime_refresh.RUNTIME_DIR", base / "runtime_outputs/historical_runtime"), mock.patch(
                "tae_historical_runtime_refresh.REPORT_MD", base / "TAE_HISTORICAL_RUNTIME_REPORT.md"
            ), mock.patch(
    ...
    def test_runtime_state_written(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch("tae_historical_runtime_refresh.RUNTIME_DIR", state_path.parent), mock.patch(
                ...
                # touch files so audit shows fresh after refresh
                for spec_path in (
