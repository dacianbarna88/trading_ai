...
- Global growth score: **44.2** / 100
- Portfolio growth quality: **54.0**
- Profit capture rate: **0.2912**
- Opportunity cost total: **$829.72**
- Growth risk index: **22.7**
- Recommended portfolio strategy: **HOLD_AND_MONITOR_SHADOW**
- Tickers integrated: **22**
...
| metric | value |
| --- | --- |
| global_growth_score | 44.2 |
| portfolio_growth_quality | 54.0 |
| capital_efficiency | 49.6 |
| opportunity_index | 17.1 |
| winner_concentration_pct | 22.7 |
| growth_risk | 22.7 |
| growth_maturity_pct | 9.1 |
| profit_capture_rate | 0.2912 |
| opportunity_cost_total | 829.72 |
| top_growth_candidates | ['MRK', 'PG', 'SPY', 'PM', 'LLY'] |
| top_risk_candidates | ['AMAT', 'MU', 'HSBA.L', 'LLY', 'PM'] |
| top_missed_winners | ['HSBA.L', 'MU', 'AMAT', 'LLY', 'PM'] |
| recommended_portfolio_shadow_strategy | HOLD_AND_MONITOR_SHADOW |
| portfolio_verdict | PORTFOLIO_HIGH_RISK |
| policy_state | WATCH |
| suggested_shadow_policy | REDUCE_NEW_BUY_AGGRESSION_SHADOW |

## Top growth candidates

| ticker | growth_score | winner_quality | strategy |
| --- | --- | --- | --- |
| MRK | 92.8 | 100.0 | KEEP_GROWING_SHADOW |
| PG | 92.4 | 100.0 | KEEP_GROWING_SHADOW |
| SPY | 86.5 | 96.9 | KEEP_GROWING_SHADOW |
| PM | 83.6 | 96.9 | KEEP_GROWING_SHADOW |
| LLY | 75.2 | 79.8 | KEEP_GROWING_SHADOW |
...
| HSBA.L | 100.0 | 0.92 | COLLAPSED | REDUCE_EXPOSURE_SHADOW |
| LLY | 19.4 | 0.274 | EARLY_WINNER | KEEP_GROWING_SHADOW |
| PM | 15.6 | 0.236 | EARLY_WINNER | KEEP_GROWING_SHADOW |
...
| PM | $22.25 | REENTRY_MISSED | CAPTURED_WINNER |

## Per-ticker growth intelligence table

| ticker | growth | winner Q | opp | lifecycle | stage | strategy | conf |
| --- | --- | --- | --- | --- | --- | --- | --- |
| MRK | 92.8 | 100.0 | 0.4 | 98.1 | SURVIVED | KEEP_GROWING_SHADOW | 1.0 |
| PG | 92.4 | 100.0 | 1.1 | 97.4 | SURVIVED | KEEP_GROWING_SHADOW | 1.0 |
| SPY | 86.5 | 96.9 | 5.5 | 88.9 | EARLY_WINNER | KEEP_GROWING_SHADOW | 1.0 |
| PM | 83.6 | 96.9 | 15.6 | 83.3 | EARLY_WINNER | KEEP_GROWING_SHADOW | 1.0 |
| LLY | 75.2 | 79.8 | 19.4 | 87.4 | EARLY_WINNER | KEEP_GROWING_SHADOW | 1.0 |
| MC.PA | 68.4 | 74.5 | 12.6 | 66.5 | DISCOVERY | HOLD_AND_MONITOR_SHADOW | 1.0 |
| AAPL | 54.7 | 52.5 | 2.4 | 61.3 | DISCOVERY | HOLD_AND_MONITOR_SHADOW | 1.0 |
| SIE.DE | 47.4 | 52.5 | 5.1 | 48.0 | DISCOVERY | HOLD_AND_MONITOR_SHADOW | 1.0 |
| ABBV | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| AIR.PA | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| ALV.DE | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| DIA | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| GE | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| HD | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| NVDA | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| SAP.DE | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| SHEL.L | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
| ULVR.L | 32.8 | 48.0 | 0.0 | 0.0 | UNKNOWN | HOLD_AND_MONITOR_SHADOW | 0.75 |
...
| strategy | count |
| --- | --- |
| HOLD_AND_MONITOR_SHADOW | 13 |
| KEEP_GROWING_SHADOW | 5 |
