...
echo "LaunchAgent (login): $PLIST_DST"
echo "Runs on login: startup_runner.sh"
echo ""
echo "IMPORTANT: login agent alone is NOT enough after sleep."
echo "Install periodic guard (recommended):"
echo "  ./install_market_day_schedule.sh"
echo "  or: ./install_market_session_guard_agent.sh"
echo ""
echo "Manual test:"
