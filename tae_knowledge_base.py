...
OUTPUT_JSON = generated_report("tae_knowledge_base.json")
OUTPUT_MD = generated_report("tae_knowledge_base.md")
OUTPUT_SUMMARY_MD = generated_report("tae_knowledge_summary.md")
