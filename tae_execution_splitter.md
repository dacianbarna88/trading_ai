...
**Experiment ID:** EXP128701

> **Routing only — no execution, no portfolio change, no live behavior change**

## Executive summary

- Decision events processed: **702**
- Jobs built this run: **1404**
- Jobs appended: **1404** (skipped duplicates in run: **0**)
- Competitive jobs: **702**
- Collaborative jobs: **702**
- Blocked jobs: **108**
- Ready jobs: **1296**
...
| --- | --- |
| total_events | 702 |
| competitive_jobs | 702 |
| collaborative_jobs | 702 |
| blocked_jobs | 108 |
| ready_jobs | 1296 |
| queued_jobs | 0 |
| invalid_jobs | 0 |
...
| SPY | READY | READY | DEFENSIVE_POLICY |
